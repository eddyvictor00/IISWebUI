...
//                window.location.href = "aiiend.html";
            ...
            var per = (perfAllBalPercent * 1).toFixed(2);
            var perSt = per + "";
...
$("#clearsubmit").click(function () {
    ...
    var spAccfundId = -accfundId;
    $.ajax({
        url: iisurl + "/cust/" + custObj.username + "/acc/" + spAccfundId + "/clearfundbalance",
        crossDomain: true,
        cache: false,
        timeout: INT_TIMOUT, //120 sec,
    ...
    function handleResult(result) {
        ...
        window.location.href = "aiifundperf.html";
        return;
    }
});
